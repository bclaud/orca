  ...
  packages = with beamPackages; with self; {
    ...
    floki = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "11g88v4l6z5lm4kmfbkiszrldipqgqvhappnm2f27ha558qn56yc";
      };
    ...
    phoenix = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "11vl1zs5jdrgbia4yg2mqynxnqk6ywmy9h6w4nv5a31kcwpxxavi";
      };
    ...
    phoenix_html = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "1vsnal4qbkk9kbwqhr94qbybm03430cwcdlr60r037s96camqb17";
      };
    ...
    phoenix_live_view = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "0zqlg572yi6nsjj7vnp8spdr2s889fn4mrcz9shna98hg5nfgjwy";
      };
